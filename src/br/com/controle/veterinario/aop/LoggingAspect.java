package br.com.controle.veterinario.aop;
...
public class LoggingAspect {
	...
	public void logaNoComeco(JoinPoint joinPoint) {
		...
		System.out.println("Executando metodo: " + methodName + " da classe: " + typeName);
	}
	
	@Pointcut("execution(* br.com.controle.veterinario.service..*.*(..))")
